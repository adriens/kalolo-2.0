...
export class MediaComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.mediaService
      ...
      .subscribe(
        (res: HttpResponse<IMedia[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IMedia[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
