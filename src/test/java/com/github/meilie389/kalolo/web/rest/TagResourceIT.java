...
import com.github.meilie389.kalolo.domain.Tag;
import com.github.meilie389.kalolo.repository.TagRepository;
...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getDefinition()).isEqualTo(DEFAULT_DEFINITION);
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.getDefinition()).isEqualTo(UPDATED_DEFINITION);
    }
